...
<!--        <script>
    ...
    <body style=" font-family:'Open Sans' ;" >
        <div><div style="display: inline; float:left;" class="center"><h3>SURAT KETERANGAN MELAKSANAKAN TUGAS TAMBAHAN</h3></div><div class="pull-right"><a class="btn btn-small btn-primary" id="print"><i class="icon-print"></i> Cetak Laporan</a></div></div>
        <table class="tabel" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="4" style="width:99px;">Telah melaksanakan:</td>
                </tr>
                ...
                foreach ($tgstambah['uraians'] as $tambahan) {
                    ...
                    <tr>
                        <td></td>
                        <td style="width:1px;">&nbsp;</td>
                        <td style="width:28px;" colspan="3"><?php echo $no; ?>.&nbsp<?php echo $tambahan; ?></td>
                    </tr>
                    <?php
                    $no++;
                }
                ...
                <tr>
                    <td></td>
                    <td style="width:1px;">b.</td>
                    <td colspan="4">Jumlah tugas tambahan yang diberikan <?php echo ($no - 1); ?> diberikan nilai <?php echo tugasTambahan(($no-1));?></td>
                </tr>
                <tr>
